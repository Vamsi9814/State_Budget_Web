...
function CitHome() {
      ...
      const handleFAMinistryClick=()=>{
        navigate("/minfolder/fachi");
      }

      const handleFDMinistryClick=()=>{
        navigate("/minfolder/fdev");
      }

      const handleUAMinistryClick=()=>{
        navigate("/minfolder/uachi");
      }

      const handleUDMinistryClick=()=>{
        navigate("/minfolder/udev");
      }

      const handleEAMinistryClick=()=>{
        navigate("/minfolder/eachi");
      }

      const handleEDMinistryClick=()=>{
        navigate("/minfolder/edev");
      }
          ...
          <header className="App-header">
            ...
            <nav>
              ...
              <li className="nav-item">
                ...
                <li className="nav-item">
                    <Link to="/statefolder/achieve" className="nav-link">State</Link>
                </li>
                <li className="nav-item">
                ...
                <li className="dropdown nav-item">
                  ...
                  <div className="dropdown-content">
                    ...
                    >
                      Rural
                      {activeMinistry === 'finance' && (
                        <div className="sub-options">
                          <div
                            className={`sub-option${activeSubOption === 'finance-a' ? ' active' : ''}`}
                            onClick={() => handleFAMinistryClick()}
                          >
                            a
                          </div>
                          <div
                            className={`sub-option${activeSubOption === 'finance-b' ? ' active' : ''}`}
                            onClick={() => handleFDMinistryClick()}
                          >
                            b
                          </div>
                        </div>
                      ...
                      {activeMinistry === 'urban' && (
                        <div className="sub-options">
                          <div
                            ...
                            onClick={() => handleUAMinistryClick()}
                          >
                            a
                          </div>
                          <div
                            className={`sub-option${activeSubOption === 'urban-b' ? ' active' : ''}`}
                            onClick={() =>handleUDMinistryClick()}
                          >
                            b
                          </div>
                        </div>
                      ...
                      {activeMinistry === 'education' && (
                        <div className="sub-options">
                          <div
                            ...
                            onClick={() => handleEAMinistryClick()}
                          >
                            a
                          </div>
                          <div
                            className={`sub-option${activeSubOption === 'education-b' ? ' active' : ''}`}
                            onClick={() => handleEDMinistryClick()}
                          >
                            b
                          </div>
                        </div>
